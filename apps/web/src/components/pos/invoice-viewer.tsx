  ...
  return (
    <div className="flex flex-col gap-4 text-foreground select-none">
      ...
      <div className="flex items-center justify-between p-3 bg-accent border border-border rounded-xl">
        <h3 className="text-xs sm:text-sm font-bold text-foreground">A4 Invoice Document Viewer</h3>
      ...
      {/* A4 Sheet Paper */}
      <div className="flex justify-center bg-muted/40 p-8 border border-border rounded-2xl print:bg-white print:border-none print:p-0 print:m-0">
        <div className="w-[800px] bg-white text-slate-800 p-8 font-sans shadow-2xl flex flex-col justify-between min-h-[1050px] print:shadow-none print:p-0 print:m-0 print:w-full">
          ...
          <div className="space-y-6">
            <div className="flex justify-between items-start pb-6 border-b border-slate-100">
              <div className="text-left">
                <div className="flex items-center gap-2 mb-2">
                  <span className="h-6 w-6 rounded bg-accent flex items-center justify-center text-emerald-400 font-bold">
                    E
                  </span>
                ...
                <p className="text-xs text-muted-foreground mt-1">VAT: VAT-99120281 | Reg: REG-99128</p>
              </div>
              ...
              <div className="text-right">
                ...
                <div className="text-xs text-muted-foreground mt-2.5 space-y-0.5 font-mono">
            ...
            <div className="grid grid-cols-2 gap-8 py-2">
              <div className="text-left bg-slate-50 p-4 rounded-xl border border-slate-100">
                <span className="text-[10px] text-muted-foreground block uppercase font-bold tracking-wider mb-1.5">
                  Billed To (Customer Details)
                </span>
                <h4 className="text-sm font-bold text-slate-800 mb-1">
                  {transaction.customerName}
                </h4>
                <p className="text-xs text-muted-foreground">ID: {transaction.customerId}</p>
              ...
              <div className="text-left bg-slate-50 p-4 rounded-xl border border-slate-100">
                ...
                <p className="text-xs text-muted-foreground">Terminal ID: T-01</p>
                <p className="text-xs text-muted-foreground mt-1">
            ...
            <table className="w-full text-xs text-left border-collapse mt-4">
              <thead>
                <tr className="border-b-2 border-slate-200 text-muted-foreground font-bold uppercase tracking-wider text-[10px] bg-slate-50">
              ...
              <tbody className="divide-y divide-slate-100 font-medium text-slate-700">
                <tr className="hover:bg-slate-50/50">
                  <td className="py-3 px-3">
                    ...
                    <p className="text-[10px] text-muted-foreground">SKU: KBD-WIRELESS-01</p>
                  </td>
                ...
                <tr className="hover:bg-slate-50/50">
                  <td className="py-3 px-3">
                    ...
                    <p className="text-[10px] text-muted-foreground">SKU: MSE-ERGO-02</p>
                  </td>
          ...
          <div className="text-center text-[10px] text-muted-foreground border-t border-slate-100 pt-6 mt-8 space-y-1">
            <p className="font-bold text-muted-foreground">Terms & Conditions</p>

            ...
            <table className="w-full text-left border-collapse text-xs">
              ...
              <tbody className="divide-y divide-border/40 text-muted-foreground">
                {dummySpools.map((spool) => (
                  <tr key={spool.id} className="hover:bg-muted/20">
                    <td className="py-3 font-sans font-bold text-foreground">{spool.name}</td>
                    <td className="py-3 text-muted-foreground">{spool.size}</td>

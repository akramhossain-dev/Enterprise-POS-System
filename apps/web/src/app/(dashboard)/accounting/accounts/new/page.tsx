...
import { useCreateAccount, useAccounts } from '@/hooks/use-accounting';
...
export default function POSCreateAccountPage() {
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 text-xs sm:text-sm">
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="grid gap-1.5">
                ...
                <Input
                  type="text"
                  placeholder="E.g., Operating cash safe"
                  {...register('name')}
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="grid gap-1.5 text-left">
                ...
                {errors.type && <p className="text-[10px] text-rose-455">{errors.type.message}</p>}
              </div>
            ...
            >
              ...
              <span>{createMutation.isPending ? 'CREATING...' : 'SAVE LEDGER ACCOUNT'}</span>
            </Button>
          </form>
        </CardContent>
      </Card>
